//UIUC CS125 FALL 2014 MP. File: LinkedList.java, CS125 Project: Challenge6-RecursionSee, Version: 2015-10-26T21:29:19-0500.299404275
/**
 * @author jmgreen5
 *
 */
public class LinkedList {
	...
	public int getLetterCount() {
		if (next == null)
			...
			return next.getLetterCount() + word.length();
	}
	 ...
	 */ 
	public LinkedList find(String word2) {
		if (word.equals(word2))
			return this;
		if (next == null)
			return null;
		else
			return next.find(word2);
