//UIUC CS125 FALL 2014 MP. File: CaesarCipherTest.java, CS125 Project: Challenge3-TopSecret, Version: 2015-09-20T21:55:13-0500.813115451
...
public class CaesarCipherTest extends TestCase {
	...
	public void testPositionShift() {
		...
		String expected = "Please enter the shift value (between -25..-1 and 1..25)\n"
				...
				+ "Processed:TIGUI GYM DHA112	 KPOJ MI SOGSE GUVTX-NAOP CFDWISFM, YSS PPOC ZOM DSUER EEW QJNHQ.\n"
				+ "Please enter the source text (empty line to quit)\n"
				+ "Bye.\n";
